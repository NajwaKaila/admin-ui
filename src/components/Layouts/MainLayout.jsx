...
function MainLayout(props) {
  ...
  return (
    <>
		...
		<aside className="bg-defaultBlack w-28 md:w-44 text-special-bg2 flex flex-col justify-between px-4 py-12 flex-shrink-0">
            <div>
                <div className="mb-10">
        ...
        <div className="flex flex-wrap justify-between items-center gap-y-2">
            <div>Avatar</div>
            <div className="hidden sm:block text-xs break-all">
                Username
                <br />
                View Profile
            </div>
